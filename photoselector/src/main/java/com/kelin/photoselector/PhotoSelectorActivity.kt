...
class PhotoSelectorActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        const val KEY_TARGET_PAGE = "kelin_photo_selector_key_target_page"
        const val PAGE_ALBUM = 0x01
        const val PAGE_PREVIEW = 0x02
        const val PAGE_PLAY_VIDEO = 0x03
        ...
        internal fun createPictureSelectorIntent(context: Context, albumType: AlbumType, maxLength: Int, id: Int, maxSize: Float, maxDuration: Int): Intent {
         ...
         fun startPreview(activity: Activity, list: List<Photo>, position: Int = 0) {
